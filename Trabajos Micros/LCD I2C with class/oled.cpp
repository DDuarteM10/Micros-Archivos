 ...
 */
#include "oled.h"
I2C_Direccion SDD1306I2C;
//#define SSD1306_I2C_ADDR 0x3C
/* Write command */
#define SSD1306_WRITECOMMAND(command)      SDD1306I2C.I2C_Enviar_Dato( 0x00, (command))
/* Write data */
#define SSD1306_WRITEDATA(data)            SDD1306I2C.I2C_Enviar_Dato( 0x40, (data))
/* Absolute value */
...
void SSD1306_DrawBitmap(int16_t x, int16_t y, const unsigned char* bitmap, int16_t w, int16_t h, uint16_t color)
{
    ...
    for(int16_t j=0; j<h; j++, y++)
    {
        for(int16_t i=0; i<w; i++)
        {
            ...
            if(byte & 0x80) SSD1306_DrawPixel(x+i, y, SSD1306_COLOR_WHITE);
        }
    }
}
...
for(i = 0; i < count; i++)
dt[i] = data[i];
SDD1306I2C.I2C_Enviar_Multiples_Datos_ConRegistro(reg,data,count);
}

void ssd1306_I2C_Write(uint8_t address, char reg, char data) {
	SDD1306I2C.I2C_Enviar_Dato(reg,data);
}
